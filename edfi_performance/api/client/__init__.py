...
class EdFiAPIClient(object):
    ...
    The `dependencies` attribute allows use of clients for other resourcese in
    ...
    def delete(self, resource_id):
        if get_config_value('delete_resources').lower() == 'false':
            logger.debug(
                "Skipping delete of {} instance {} because"
                " delete_resources=False".format(
