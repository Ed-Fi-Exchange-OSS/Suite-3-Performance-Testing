...
from locust import TaskSequence, TaskSet, task
...
from edfi_performance.tasks.pipeclean import EdFiPipecleanTestTerminator
...
class AllDescriptorsPipecleanTest(TaskSequence):
