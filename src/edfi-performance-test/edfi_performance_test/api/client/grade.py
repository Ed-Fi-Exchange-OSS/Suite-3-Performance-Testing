...
class GradeClient(EdFiAPIClient):
    ...
    def create_with_dependencies(self, **kwargs):
        ...
        return self.create_using_dependencies(
            ...
            studentSectionAssociationReference__beginDate=assoc_reference["attributes"][
                "beginDate"
            ],
            studentSectionAssociationReference__studentUniqueId=assoc_reference[
                "attributes"
            ]["studentReference"]["studentUniqueId"],
            studentSectionAssociationReference__localCourseCode=section_reference[
                "localCourseCode"
            ],
            studentSectionAssociationReference__schoolId=section_reference["schoolId"],
            studentSectionAssociationReference__schoolYear=section_reference[
                "schoolYear"
            ],
            studentSectionAssociationReference__sessionName=section_reference[
                "sessionName"
            ],
            **kwargs
        )
