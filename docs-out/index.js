...
const forBestViewing = `
    <div style="border: 1px solid green; padding: 1em; background-color: #dff0d8">
        ...
        please visit the <a href="https://github.com/Ed-Fi-Alliance/Ed-Fi-X-Performance">online 
        version of this document</a>.
    </div>
`;
const outputFile = 'ed-fi-performance.pdf';
    ...
    preProcessHtml: () => {
        return through(function (data, _enc, cb) {
            ...
            var wrapped = `<div class="markdown-body">${forBestViewing}${data.toString()}</div>`
                ...
                .replace(/docs\/([^\.]+)\.md/g, 'https://github.com/Ed-Fi-Alliance/Ed-Fi-X-Performance/blob/master/docs/$1.md');
...
var docs = [
    ...
    path.join(__dirname, '..', 'docs', 'performance-testing-framework.md')
];
